...
public class TodoItemTouchHelperCallback
        extends ItemTouchHelper.Callback {

    private TodoTouchHelperAdapter todoTouchHelperAdapter;

    public TodoItemTouchHelperCallback(
            TodoTouchHelperAdapter todoTouchHelperAdapter) {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        todoTouchHelperAdapter.onItemDismiss(
